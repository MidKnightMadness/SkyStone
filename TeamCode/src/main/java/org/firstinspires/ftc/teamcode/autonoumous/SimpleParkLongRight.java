...
@Autonomous
public class SimpleParkLongRight extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Position targetPos = new Position(Distance.fromInches(0), Distance.fromInches(25.75), Angle.fromDegrees(0));
        ...
        targetPos.setX(Distance.fromInches(-41));
        drive.setTarget(targetPos, navigation);
